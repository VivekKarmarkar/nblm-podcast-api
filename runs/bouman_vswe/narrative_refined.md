...
Way smaller. Wait, here's the part that breaks your brain. The same technique they used for the Jello cube — developed in earlier research by Katie Bouman's collaborators — can detect motion on the order of one thousandth of a pixel. Think about that. A single pixel sliced into a thousand pieces, and they can pick up motion smaller than one of those slices.
